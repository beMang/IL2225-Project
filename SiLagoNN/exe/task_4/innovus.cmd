...
#  Created on Sun Jan  4 16:19:39 2026                
#                                                     
#######################################################
...
#@ Begin verbose source (pre): source ../../phy/scr/flat.tcl
...
set SCR_DIR    "../../phy/scr/"
set OUTPUT_DIR "../../phy/db/task_4"
set RPT_DIR    "../../phy/rpt/task_4"
set SRC_DIR    "../../syn/db/task_2"
...
set NETLIST_FILE       "${SRC_DIR}/${TOP_NAME}_20000ps.v"
...
#@ End verbose source: ../../phy/scr/flat.tcl
#@ source ../../phy/scr/flat.tcl
#@ Begin verbose source (pre): source ../../phy/scr/flat.tcl
#@ source ../../phy/scr/read_design.tcl
#@ Begin verbose source ../../phy/scr/read_design.tcl (pre)
