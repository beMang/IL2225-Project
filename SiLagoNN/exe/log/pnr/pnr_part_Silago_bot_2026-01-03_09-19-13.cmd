...
#  Created on Sat Jan  3 09:19:34 2026                
#                                                     
#######################################################
...
#@ source ../../../scr/pnr_partition.tcl
#@ Begin verbose source (pre): source ../../../scr/pnr_partition.tcl
#@ source ../../../scr/global_variables.tcl
#@ Begin verbose source ../../../scr/global_variables.tcl (pre)
set NUM_CPUS 8
...
#@ End verbose source ../../../scr/global_variables.tcl
#@ source ../../../scr/design_variables.tcl
#@ Begin verbose source ../../../scr/design_variables.tcl (pre)
...
set master_partition_module_list {
	...
	Silago_bot \
	Silago_bot_right_corner }
#@ End verbose source ../../../scr/design_variables.tcl
read_db .
place_design
ccopt_design
route_design
write_db ./pnr/
write_ilm
#@ End verbose source: ../../../scr/pnr_partition.tcl
