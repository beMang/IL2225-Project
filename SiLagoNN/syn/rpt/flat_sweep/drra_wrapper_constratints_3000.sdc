...
****************************************
    ...
    -----------------------------------------------------
    clk                        154.68      1.00    154.68
    default                      0.00      1.00      0.00
    -----------------------------------------------------
    max_delay/setup                                154.68

                              Total Neg  Critical
    Group (critical_range)      Slack    Endpoints   Cost
    -----------------------------------------------------
    clk                      243827.53        1    154.68
    default                      0.00         0      0.00
    -----------------------------------------------------
    critical_range                                 154.68
    ...
    max_delay/setup                                154.68 (VIOLATED)
    sequential_clock_pulse_width                     0.00 (MET)
    critical_range                                 154.68 (VIOLATED)
