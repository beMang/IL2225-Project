# set some directories according to task 4 or 6
...
# Task 6:
# set OUTPUT_DIR "../../phy/db/task_6"
# set RPT_DIR    "../../phy/rpt/task_6"
# set SRC_DIR    "../../syn/db/task_3"
# set PART_DIR   "../../phy/db/task_6/part"
